...
const SignIn: React.FC = () => {
  ...
  const handleCredentialsSignIn = async (event: React.FormEvent) => {
    ...
    if (result?.ok) {
      router.push('/dashboard');
      //window.location.href = '/ai-influencer'; //this is to force a page refresh
    } else {
  ...
  return (
    <div className="py-10 px-5">
      ...
      <div className="signin-container max-w-md mx-auto my-10 p-8 border rounded-xl shadow-lg bg-white">
      <div className="logo flex justify-center mb-6 rounded-full">
